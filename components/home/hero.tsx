  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-secondary">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <motion.div
          style={{ y: y1 }}
          className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-primary/20 rounded-full blur-[150px]"
        />
        <motion.div
          style={{ y: y2 }}
          className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-accent/20 rounded-full blur-[150px]"
        />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-8 leading-[1] tracking-tighter">
              Precision <br />
              Beyond <br />
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Button size="lg" className="rounded-2xl h-16 px-10 text-xl font-bold shadow-2xl shadow-primary/40 group overflow-hidden relative" asChild>
                <Link href="/contact">
            ...
            <div className="mt-16 flex items-center space-x-8 opacity-50">
              {[ShieldCheck, Activity, Gauge, Zap].map((Icon, i) => (
                <Icon key={i} className="h-8 w-8 text-white" />
              ))}
            </div>
          </motion.div>
            ...
            <div className="relative w-full aspect-square max-w-2xl mx-auto">
              ...
              {[...Array(3)].map((_, i) => (
                <motion.div
                  ...
                  className={cn(
                    "absolute inset-0 rounded-[4rem] border border-white/5",
              ...
              {/* Main Visual */}
              <div className="absolute inset-0 m-12 bg-gradient-to-br from-white/10 to-transparent backdrop-blur-2xl rounded-[4rem] border border-white/10 shadow-2xl overflow-hidden flex items-center justify-center p-12">
                <div className="relative w-full h-full">
                  <Image
                    src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800"
                    alt="Precision Engineering"
                    fill
                    className="object-cover rounded-3xl opacity-40 mix-blend-overlay"
                  />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <motion.div
                      ...
                      className="w-48 h-48 bg-primary rounded-full flex items-center justify-center shadow-[0_0_80px_rgba(0,87,217,0.6)] border-8 border-white/10"
                    >
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-accent text-sm font-bold">99.998%</div>
                  </div>
                </div>
              </motion.div>
      ...
      >
        <span className="text-white/30 text-xs font-bold uppercase tracking-[0.4em]">Scroll</span>
