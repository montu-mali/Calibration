        ...
        <div className="bg-muted dark:bg-muted/50 rounded-[2.5rem] p-10 md:p-12 border border-border shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-wrap justify-center lg:justify-between items-center gap-12 relative z-10">
            {BADGES.map((badge, index) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-background shadow-sm border border-border flex items-center justify-center transition-all duration-300 group-hover:bg-primary group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-primary/20">
                  <badge.icon className="h-7 w-7 text-primary group-hover:text-white transition-colors" />
                </div>
                <div>
                  <span className="text-foreground font-bold text-base md:text-lg block group-hover:text-primary transition-colors">
                    {badge.label}
                  </span>
                  <span className="text-muted-foreground text-xs font-bold uppercase tracking-widest">Verified</span>
                </div>
              </motion.div>
            ))}
          </div>
